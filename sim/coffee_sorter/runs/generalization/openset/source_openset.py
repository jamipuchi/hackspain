...
def _demo_unknown_record(bean, decision, reject_mask, anomaly_threshold, fired_targets) -> dict:
    ...
    if video:
        ...
        if rejected_examples:
            ...
            demo_record = _demo_unknown_record(
                ...
                model.anomaly_thresh, sim.fired_targets)
